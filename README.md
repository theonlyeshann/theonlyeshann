...
- Worked in **Agile-style environments** with distributed and offshore teams  
- Collaborated across time zones using Git, GitHub, and clear documentation  
- Gained experience breaking down tasks, iterating on feedback, and shipping incrementally  

---------------------

## 🌍 Outside of code
- 🏀 Basketball film analysis and stats  
- 🗣 Multilingual: English, Spanish, Portuguese, Hindi  
